...
int GraphicsController::count_cell_y() const
{
  return num_cell_y;
}

int GraphicsController::width_win() const
{
  return _width_win;
}

int GraphicsController::height_win() const
{
  return _height_win;
}

int GraphicsController::width_win_map() const
{
  return _width_win_map;
}

int GraphicsController::height_win_map() const
{
  return _height_win_map;
}

int GraphicsController::width_map() const
{
  return _width_map;
}

int GraphicsController::height_map() const
{
  return _height_map;
}

QPoint GraphicsController::win_map_center() const
{
  return _win_map_center;
}

void GraphicsController::draw_map()
{
  map->draw(map_center);
}
...
void GraphicsController::resize_win(const QSize& new_size)
{
...
void GraphicsController::do_contents()
{
